...
'functions.R' file contains the main functions we used to implement methods discussed in the paper, it includes functions
for claims reserving using GAM and robust GAM.
